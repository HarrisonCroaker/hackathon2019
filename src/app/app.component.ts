...
export class MyApp {
  ...
  constructor(platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen,public authService: AuthProvider, public userService: UserProvider, public messagesService: MessagesProvider,private toastCtrl: ToastController) {
